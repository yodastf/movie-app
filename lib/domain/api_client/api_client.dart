...
class ApiClient{
  ...
  static const _apiKey ='1jLKmfaG34fdfmalfSG3mkaT24lKf2';
    ...
    final parameters = <String, dynamic>{
     ...
     void _validateResponse(HttpClientResponse response, Map<String, dynamic> json) {
        ...
        throw ApiClientException(ApiClientExceptionType.Auth);
                ...
                }else if(code == 3){throw ApiClientException(ApiClientExceptionType.SessionExpired);}
                else{throw ApiClientException(ApiClientExceptionType.Other);}
                }
     }
